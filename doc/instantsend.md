...
This mechanism has been integrated into Bitcore-Node-Wildfire which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/wildfirepay/insight-api-wildfire#web-socket-api](https://github.com/wildfirepay/insight-api-wildfire#web-socket-api)
* API: [https://github.com/wildfirepay/insight-api-wildfire#instantsend-transactions](https://github.com/wildfirepay/insight-api-wildfire#instantsend-transactions)
