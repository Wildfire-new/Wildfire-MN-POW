...
This document provides guidelines for internationalization of the Wildfire Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wildfire_en.ts` remains unchanged.
