...
Arguments:
    <base_directory> - The base directory of a Wildfire Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Wildfire Core developers'
...
Arguments:
    <base_directory> - The base directory of Wildfire Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Wildfire Core repository.
"""
