...
official/supported Docker Images found at https://hub.docker.com/r/wildfirepay/wildfired/
...
**NOTE: Please update the image description at https://hub.docker.com/r/wildfirepay/wildfired-develop/ when changing the above text**