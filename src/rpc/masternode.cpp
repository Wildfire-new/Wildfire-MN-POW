...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Wildfire address\n"
            "  payee          - Print the masternode payout Wildfire address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Wildfire address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "wildfire",               "masternode",             &masternode,             true,  {} },
    { "wildfire",               "masternodelist",         &masternodelist,         true,  {} },
    { "wildfire",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "wildfire",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
